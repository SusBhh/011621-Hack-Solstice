...
public class subwayfirst extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_subwayfirst);

        Button subwayFirstWebsite = (Button)findViewById(R.id.subwayFirstWebsite);
        subwayFirstWebsite.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Button subwayFirstMap= (Button)findViewById(R.id.subwayFirstMap);
        subwayFirstMap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Button subwayFirstDelivery = (Button)findViewById(R.id.subwayFirstDelivery);
        subwayFirstDelivery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
